			...
			comboBox.setEventHandler(new EventHandler<OptionElement>() {
				...
				public void getPage(int pageNumber, boolean skipBlur) {
					if (!org.vaadin.grid.enhancements.client.cellrenderers.combobox.singleselect.ComboBoxRendererConnector.ComboBoxRenderer.this.filter
						.isEmpty()) {
						ComboBoxRendererConnector.this.rpc
							.getFilterPage(	org.vaadin.grid.enhancements.client.cellrenderers.combobox.singleselect.ComboBoxRendererConnector.ComboBoxRenderer.this.filter,
											pageNumber, EditableRendererClientUtil.getCellId(comboBox));
					} else {
						ComboBoxRendererConnector.this.rpc.getPage(	pageNumber,
																	EditableRendererClientUtil.getCellId(comboBox));
					}
				}
				...
				public void filter(String filterValue, int pageNumber, boolean skipBlur) {
					...
					ComboBoxRendererConnector.this.rpc.getFilterPage(	filterValue, pageNumber,
																		EditableRendererClientUtil.getCellId(comboBox));
				}
