...
public class NavigationHandler implements KeyDownHandler {
    ...
    public NavigationHandler(final Grid grid, final GridFocusHandler gridFocusHandler) {
        this.grid = grid;
    ...
    public void onKeyDown(final KeyDownEvent keyDownEvent) {
        ...
        switch (keyDownEvent.getNativeKeyCode()) {
            case KeyCodes.KEY_ESCAPE:
                ...
                NavigationUtil.focusCell(this.grid, cellReference.getRowIndex(), cellReference.getColumnIndexDOM(), this.gridFocusHandler);
            ...
            case KeyCodes.KEY_UP:
                ...
                while (cellReference.getRowIndex() > 0) {
                    // move down one row
                    NavigationUtil.focusCell(this.grid, cellRowIndex, cellReference.getColumnIndexDOM(), this.gridFocusHandler);
                    final Cell cell = NavigationUtil.getFocusedCell(this.grid);
            ...
            case KeyCodes.KEY_TAB:
                ...
                if (shiftKeyDown) {
                    ...
                    new Timer() {
                        ...
                        public void run() {
                            ...
                            if (cnt == -1) {
                                ...
                                NavigationUtil.focusLastEditableElementFromFirstElementOfRow(NavigationHandler.this.grid, cellReference.getRowIndex() - 1,
                                                                                             NavigationHandler.this.gridFocusHandler, shiftKeyDown);
                                return;
                            }
                    ...
                    if (NavigationUtil.isLastCell(cellReference, NavigationHandler.this.grid, tdElement, shiftKeyDown) && this.secondTimeTabWithoutShift) {
                    ...
                    new Timer() {
                        ...
                        public void run() {
                            ...
                            if (cnt == -1) {
                                // no steppable element found in this row
                                // Step down one row and to the first column
                                NavigationUtil.focusFirstEditableElementFromFirstElementOfRow(NavigationHandler.this.grid, cellReference.getRowIndex() + 1,
                                                                                              NavigationHandler.this.gridFocusHandler, shiftKeyDown);
                                return;
                            }
     ...
     */
    private Element getCellElement(final Element focusedElement) {
