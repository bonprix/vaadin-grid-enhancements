...
public final class ItemCaptionGeneratorFilter<BEANTYPE> implements Filter {
	...
	public ItemCaptionGeneratorFilter(final Function<BEANTYPE, String> itemCaptionGenerator, Object propertyId,
			final String filterString, final boolean ignoreCase, final boolean onlyMatchPrefix,
			final BeanItemContainer<BEANTYPE> container) {
	...
	public boolean passesFilter(final Object itemId, final Item item) {
		final Property<?> idProperty = item.getItemProperty(this.propertyId);
		if (idProperty.getValue() == null) {
			return false;
		}

		String value = this.itemCaptionGenerator.apply((BEANTYPE) itemId);
		value = this.ignoreCase ? value.toString()
	...
	public boolean equals(final Object obj) {
		...
		if (this.filterString != o.filterString && o.filterString != null
